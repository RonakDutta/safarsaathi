  ...
  return (
    <div className="grid min-h-screen bg-ink lg:grid-cols-[1.05fr_1fr]">
      ...
      <div className="relative isolate hidden overflow-hidden border-r border-white/[0.06] bg-coal lg:flex lg:flex-col">
        ...
        <div className="absolute top-1/3 left-1/2 -z-10 h-[30rem] w-[30rem] -translate-x-1/2 rounded-full bg-amber/15 blur-[130px]" />
        <div className="checker h-3 [--sq:6px]" />

        <div className="flex flex-1 flex-col justify-between p-12 xl:p-16">
          <Logo className="text-2xl" />

          <div className="animate-float mx-auto w-full max-w-[17rem] rounded-[2rem] border border-white/[0.08] bg-panel/80 p-6 shadow-[0_40px_100px_-30px_rgb(0_0_0/1)] backdrop-blur">
      ...
      <div className="relative isolate flex flex-col px-4 py-5 sm:px-10 sm:py-8">
        <div className="absolute top-0 right-0 -z-10 h-72 w-72 rounded-full bg-amber/10 blur-[110px] lg:hidden" />
